                ...
                <row :gutter="10" :columns="5">
                    <column :xs="5" :sm="5" :md="5" :lg="3">
                        <div class="greeting" :class="{'night':isNight}">
                            ...
                            <div class="text">
                                ...
                                <div class="message">{{LANG.panel.welcome_to_panel}}</div>
                            </div>
                            <div class="action">
                                <router-link :to="{name:'quiz-home'}" class="btn btn-sm btn-outline-primary">
                                    {{LANG.quiz.manage_exams}}
                                </router-link>
                            </div>
                        </div>
                    </column>
                    <column v-if="!!stats" :xs="2" :sm="2" :md="2" :lg="1">
                        <div class="single-stat purple">
                            <div class="caption">{{LANG.quiz.count_exams}}</div>
                            <div class="amount">{{stats.quiz}}</div>
                            <div class="unit">{{LANG.quiz.exam}}</div>
                        </div>
                    </column>
                    <column v-if="!!stats" :xs="3" :sm="3" :md="3" :lg="1">
                        <div class="single-stat red">
                            <div class="caption">{{LANG.quiz.count_questions}}</div>
                            <div class="amount">{{stats.question}}</div>
                            <div class="unit">{{LANG.quiz.question}}</div>
                        </div>
                    </column>
                </row>
                <br>
