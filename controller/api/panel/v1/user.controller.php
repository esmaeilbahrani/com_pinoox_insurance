...
use pinoox\app\com_pinoox_insurance\model\PorseshDatabase;
...
use pinoox\app\com_pinoox_insurance\model\UserModel;
    ...
    public function logout()
{
    ...
    public function add()
    {
        ...
        PorseshDatabase::startTransaction();
        $user_id = UserModel::insert($input);
        PorseshDatabase::commit();
